...
void setup() {
  ...
  // I2C pins for MPU6050: SDA = GPIO21, SCL = GPIO22
  Wire.begin(21, 22);
...
void loop() {
  ...
  // Explicit payload format for Android parsing and future extensions.
  // Current: "id=<n>;acc_mg=<value>"
  // Planned extension example: "id=<n>;acc_mg=<v>;temp_c=<v>;hr_bpm=<v>"
